...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        var temp = this._httpService.get('/api/customers').forEach(function (obj) { return obj.json(); });
        var temp2 = this._httpService.get('/api/customers').subscribe(function (res) { return res.json().response; });
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_models_customer__WEBPACK_IMPORTED_MODULE_4__["Customer"]],
            bootstrap: [
                _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"]
            ]
        })
